...
tau = st.sidebar.slider("tau", 0, 400, 200, step=1)
theta = st.sidebar.slider("theta", 0.1, 5.0, 1.0)
n = st.sidebar.slider("n", 1, 20, 10)
x0 = st.sidebar.slider("x0 (initial value)", 0.0, 16.0, 1.0)
N = st.sidebar.number_input("N (simulation length)", min_value=1000, max_value=2000000, value=1000000)
